...
console.log(`[ENV] WOODS_INTERNATIONAL_SERVER: ${process.env.WOODS_INTERNATIONAL_SERVER ? 'present' : 'missing'}`);
...
async function start() {
  ...
  app.listen(port, () => {
    console.log(`Woods International Report Panel Backend listening on port ${port}`);
  });
}
